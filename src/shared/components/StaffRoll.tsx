      ...
      >
        ...
        >
          ...
          <div className="text-center" style={{ marginBottom: '8cqmin' }}>
            ...
            <div style={{ fontSize: '3cqmin', color: '#9ca3af', marginTop: '2cqmin' }}>
              Staff Roll
            </div>
          </div>
          ...
          {staffData.map((roleData, i) => (
            <div key={i} className="text-center" style={{ marginBottom: '6cqmin' }}>
              <div
                className="font-bold"
                style={{ fontSize: '3.5cqmin', color: '#fbbf24', marginBottom: '2cqmin' }}
              >
                {roleData.role}
              </div>
          ...
          <div className="text-center" style={{ marginTop: '8cqmin', marginBottom: '4cqmin' }}>
            <div style={{ fontSize: '3.5cqmin', color: 'white', lineHeight: 1.8 }}>
